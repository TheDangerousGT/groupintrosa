...
<body id="top">
   ...
   <header> 
   	...
   	<div class="header-logo">
	      <a href="index.html">Grupo Introsa</a>
	   </div> 
		   		...
		   		<div class="col-twelve">		   			
			  			<div class="home-bottom-text">
							...
							<ul class="home-section-links">
								...
								<li class="animate-intro">View <a href="#portfolio" class="smoothscroll">Our Services</a></li>
								<li class="animate-intro">Contact <a href="#contact" class="smoothscroll">Contact Us</a></li>								
							</ul>
   	...
   	<div class="about-wrap">
   		...
   		<div class="about-profile">
   			...
   			<div class="about-profile-bg"></div>
				...
				<div class="intro">
	   			...
	   			<p class="lead animate-this">Grupo Introsa is verified with “In Compliance” program of Gremial de Huleros since may 2018.

					This is an environmental and social responsibility program that requires the compliance with:
					
					Crop sustainability and quality
					Child labour free
					Traceability raw material
					Deforestation free
					Socially responsible
					Environmental compliance
					Pregnant women free of hard work</p>					
				</div>   		

   			<p class="animate-this">
				Grupo Introsa is certified ISO 9001:2015 for natural rubber process and centrifugate rubber latex.
				The scope of the certification is from the reception of the raw material to the point of delivery established with client.
				
				The four (4) sites of the organization are into the scope of the certification.	
   			</p>

   			<p class="animate-this">Grupo Introsa is certified Carbon Neutral (ISO 14064 Standards) since late 2014.

				The voluntary Carbon Neutral is through the carbon stock calculation and emissions reports of some farms to Grupo Introsa according to the standard PAS 2060.</p>

   			<p>
				<p class="animate-this">Grupo Introsa is certified ECOVADIS since February 2018.

					ECOVADIS is a method and analysis system, was built on the most demanding International Standard of CRS as: Global Reporting Initiative, United Nations world of Normative ISO 26000.
					
					The system is formed by 21 criteria divided in 4 themes: Environmental issues, Fair labor practices, Ethics/Fair Business Practices and Supply Chain.</p>
	
				   <p>
   				<a href="#contactForm" class="button full-width animate-this smoothscroll">Contact Us</a>
   		...
   		<div class="about-services">
				...
				<div class="intro">
	   			...
	   			<p class="lead animate-this">In our products we give the best quality.</p>
   			</div>
   			...
   			<ul class="services">
   				...
   				<li class="item-photography animate-this">
   					...
   					<div class="service-item">
   						<h4>Latex</h4>
   						<p> 💧 High Ammonia <br>
							💧 High Ammonia Free of TMTD Zinc Oxide <br>
							💧 Low Ammonia <br>
							💧 PV Latex Ultra Low Nitrosamines <br>
   						</p>
   					</div>   					
   				</li>
   			</ul>   			
   		...
   		<div class="col-skills">
   			...
   			<ul class="skill-bars">
				   <li class="animate-this" data-animate="fadeInRight">
				   	...
				   	<strong>Processing Rubber</strong>
				   </li>
				   <li class="animate-this" data-animate="fadeInRight">
				   	<div class="progress percent100"><span>100%</span></div>
				   	<strong>Processing Latex</strong>
				   </li>
				   <li class="animate-this" data-animate="fadeInRight">
   ...
   <section id="credentials">
   	...
   	<div class="row narrow section-intro with-bottom-sep">
   		<div class="col-twelve">
   			<h3 class="animate-this">Our Development</h3>
